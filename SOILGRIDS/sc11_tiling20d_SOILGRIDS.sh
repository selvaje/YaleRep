...
#SBATCH -n 1 -c 1 -N 1
#SBATCH -t 2:00:00
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/stdout/sc11_tiling20d_SOILGRIDS.sh.%A_%a.out  
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/stderr/sc11_tiling20d_SOILGRIDS.sh.%A_%a.err
#SBATCH --array=1-116
#SBATCH --mem=20G
...
gdalbuildvrt -overwrite -srcnodata -9999999 -vrtnodata -9999999 $SOILGRIDSSC/${dir}_acc/${tifname}_intb.vrt $(for ID in $(seq 1 59) ; do ls  $SOILGRIDSSC/${dir}_acc/intb/${tifname}_*${ID}_acc.tif ; done) 

gdalbuildvrt -overwrite -srcnodata -9999999 -vrtnodata -9999999 $SOILGRIDSSC/${dir}_acc/${tifname}_intb_5p.vrt $(for ID in $(seq 1 59) ; do ls  $SOILGRIDSSC/${dir}_acc/intb/${tifname}_*${ID}_acc_5p.tif ; done)
