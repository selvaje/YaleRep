...
#SBATCH -n 1 -c 1 -N 1
#SBATCH -t 24:00:00     
#SBATCH -o /project/fas/sbsc/hydro/stdout/sc14_tile_control_GRWL_rerunTile.sh.%J.out
#SBATCH -e /project/fas/sbsc/hydro/stderr/sc14_tile_control_GRWL_rerunTile.sh.%J.err
#SBATCH --mem=1G
#SBATCH --job-name=sc14_tile_control_GRWL_rerunTile.sh
ulimit -c 0

### sbatch   /gpfs/gibbs/pi/hydro/hydro/scripts/GRWL/sc14_tile_control_GRWL_rerunTile.sh
...
rm -f /gpfs/gibbs/pi/hydro/hydro/dataproces/GRWL/${dir}_acc/$year/${dir}_${year}_${MM}.vrt 


for tif in /gpfs/gibbs/pi/hydro/hydro/dataproces/GRWL/${dir}/${dir}_${year}_${MM}.tif ; do 
...
sbatch  --export=tif=$tif,ID=$ID --mem=${MEM}M --job-name=sc10_var_acc_intb1_GRWL_forloop_$(basename $tif .tif).sh  /gpfs/gibbs/pi/hydro/hydro/scripts/GRWL/sc10_variable_accumulation_intb1_GRWL_forloop_nofollowing.sh 
done 
sleep 1200  # 20 min
done 
...
sbatch --export=dir=$dir},year=${year},tifname=${dir}_${year}_${MM} --job-name=sc11_tiling20d_GRWL_${dir}_${year}_${MM}.sh  /gpfs/gibbs/pi/hydro/hydro/scripts/GRWL/sc11_tiling20d_GRWL.sh
