...
Y = load_with_dtypes('Ysample_5.0pct.txt', dtype_dict=dtypes_Y)

print('Loading X data...')
X = load_with_dtypes('Xsample_5.0pct.txt', usecols=lambda col: col in include_variables, dtype_dict=dtypes_X)
