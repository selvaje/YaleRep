...
#SBATCH -n 1 -c 6 -N 1
#SBATCH -t 24:00:00  
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/stdout1/sc02_curl_procGLAD_ARD.sh.%A_%a.out
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/stderr1/sc02_curl_procGLAD_ARD.sh.%A_%a.err
#SBATCH --mem=25G 
#SBATCH --job-name=sc02_curl_procGLAD_ARD.sh
#SBATCH --array=2572-19221%400
