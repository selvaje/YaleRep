...
# export VAR 
# mkdir -p  /project/fas/sbsc/ga254/dataproces/TERRACLIMATE/$VAR 
# cd /project/fas/sbsc/ga254/dataproces/TERRACLIMATE/$VAR 
...
# MM=$1
# gdal_translate -a_srs EPSG:4326  -b $MM  -co COMPRESS=DEFLATE -co ZLEVEL=9  -co INTERLEAVE=BAND   /project/fas/sbsc/ga254/dataproces/TERRACLIMATE/$VAR/TerraClimate_${VAR}_${YEAR}.nc /project/fas/sbsc/ga254/dataproces/TERRACLIMATE/$VAR/${VAR}_${YEAR}_${MM}.tif 

# ' _ 
# rm  -f   /project/fas/sbsc/ga254/dataproces/TERRACLIMATE/$VAR/TerraClimate_${VAR}_${YEAR}.nc 
# done  
...
echo 01 02 03 04 05 06 07 08 09 10 11 12 | xargs -n 1 -P 12 bash -c $' 
MM=$1
gdal_translate -a_srs EPSG:4326  -b $MM  -co COMPRESS=DEFLATE -co ZLEVEL=9  -co INTERLEAVE=BAND  NETCDF:"TerraClimate_${VAR}_${YEAR}.nc":${VAR}  /project/fas/sbsc/ga254/dataproces/TERRACLIMATE/$VAR/${VAR}_${YEAR}_${MM}.tif 
