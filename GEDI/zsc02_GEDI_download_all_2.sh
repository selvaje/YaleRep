...
#SBATCH -n 1 -c 1 -N 1
#SBATCH -t 22:00:00       # 
#SBATCH -o /gpfs/gibbs/pi/hydro/hydro/stdout1/sc02_GEDI_download_all_2.sh.%A_%a.out
#SBATCH -e /gpfs/gibbs/pi/hydro/hydro/stderr1/sc02_GEDI_download_all_2.sh.%A_%a.err
#SBATCH --job-name=sc02_GEDI_download_all_2.sh
#SBATCH --mem=2G
...
##### narray=$(grep 2020.01 /gpfs/gibbs/pi/hydro/hydro/dataproces/GEDI/date_2020.txt | wc -l )  ; sbatch  --export=YYYYMM=2020.01  --array=1-$narray /gpfs/gibbs/pi/hydro/hydro/scripts/GEDI/sc02_GEDI_download_all_2.sh 
...
export DATE=$( grep $YYYYMM  $DIRAPI/date_2020.txt | awk 'NR=='${SLURM_ARRAY_TASK_ID}''  )    ### YYYY.MM.DD
