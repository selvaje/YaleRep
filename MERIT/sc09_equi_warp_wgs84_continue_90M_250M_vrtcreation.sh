...
gdal_translate -co COMPRESS=DEFLATE -co ZLEVEL=9 -co INTERLEAVE=BAND -co  BLOCKYSIZE=512 -co  BLOCKXSIZE=512 -co COPY_SRC_OVERVIEWS=YES -mo CO=YES -co TILED=YES -a_nodata 0 -ot Byte -scale $RAM/${TOPO}_250Mbilinear_MERIT.vrt $MERIT/final250m/${TOPO}_250Mbilinear_MERITb.tif
