...
r.out.gdal --o -f -c -m createopt='COMPRESS=DEFLATE,ZLEVEL=9,BIGTIFF=YES' nodata=-9999999 type=Float64   input=varare_acc  output=$SOILGRIDSH/${dir}/${dir}_acc_sfd/intb/${tifname}_${box}_acc_sfd_Float_g84.tif 

EOF
"

source ~/bin/gdal3 &> /dev/null
gdalinfo -mm $SOILGRIDSH/${dir}/${dir}_acc_sfd/intb/${tifname}_${box}_acc_sfd_Float_g84.tif | grep Computed | awk '{ gsub(/[=,]/," " , $0 ); print $3 , $4 }' > $SOILGRIDSH/${dir}/${dir}_acc_sfd/intb/${tifname}_${box}_acc_sfd_Float_g84.mm
