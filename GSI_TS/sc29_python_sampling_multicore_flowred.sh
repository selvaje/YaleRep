...
#### sbatch  /gpfs/gibbs/pi/hydro/hydro/scripts/GSI_TS/sc29_python_sampling_multicore_flowred.sh 
...
def write_fold_to_file(fold_index):
    ...
    fold.to_csv(f'/gpfs/gibbs/pi/hydro/hydro/dataproces/GSI_TS/extract4py_sample_red/{output_prefix}{fold_index}.txt', sep=' '  , index=False, header=True)
...
cut -d " " -f1-19       $EXTRACT/extract_red/stationID_x_y_valueALL_predictors.txt  >   $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y.txt
cut -d " " -f1-8,20-    $EXTRACT/extract_red/stationID_x_y_valueALL_predictors.txt  >   $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_X.txt 

head -1  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y.txt       >  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y11.txt
grep -e ^11   $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y.txt >>  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y11.txt

head -1  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_X.txt       >  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_X11.txt
grep -e ^11   $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_X.txt >>  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_X11.txt

head -1  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y.txt       >  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y1.txt
grep -e ^1   $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y.txt >>  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y1.txt

head -1  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_X.txt       >  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_X1.txt
grep -e ^1   $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_X.txt >>  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_X1.txt
