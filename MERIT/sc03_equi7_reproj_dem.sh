...
#SBATCH -n 1 -c 12  -N 1  
#SBATCH -t 24:00:00
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/stdout/sc03_equi7_reproj_dem.sh.%J.out 
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/stderr/sc03_equi7_reproj_dem.sh.%J.err
...
export INDIR=/project/fas/sbsc/ga254/dataproces/MERIT/input_tif
export EQUI7=/project/fas/sbsc/ga254/dataproces/EQUI7
export equi7=/project/fas/sbsc/ga254/dataproces/MERIT/equi7/dem
export KM=0.10
...
pksetmask -co COMPRESS=DEFLATE -co ZLEVEL=9 -co INTERLEAVE=BAND -ot Float32  -m $DIR/../EQUI7/grids/${CT}/PROJ/EQUI7_V13_${CT}_PROJ_ZONE_KM$KM.tif -msknodata 0 -nodata -9999 -i /dev/shm/${CT}_${5}_dem_crop.tif  -o /dev/shm/${CT}_${5}_dem_msk.tif 
rm -f /dev/shm/${CT}_${5}_dem_crop.tif 

MAX=$(pkstat -max -i  /dev/shm/${CT}_${5}_dem_msk.tif | awk \'{ print $2 }\')
if [ $MAX ==  "-9999" ] ; then 
rm -f /dev/shm/${CT}_${5}_dem_msk.tif 
else 
cp /dev/shm/${CT}_${5}_dem_msk.tif  $equi7/${CT}/${CT}_${5}.tif 
