...
r.out.gdal --o -f -c -m createopt="COMPRESS=DEFLATE,ZLEVEL=9,BIGTIFF=YES,INTERLEAVE=BAND,TILED=YES"  nodata=-9999999  type=Float32 format=GTiff input=flow  output=$SC/flow_tiles_intb1/flow_${zone}${tile}.tif

gdal_edit.py -a_ullr  $wS $nS $eS $sS  $SC/flow_tiles_intb1/flow_${zone}${tile}.tif 
gdal_edit.py -tr 0.000833333333333333333333333333333333 -0.000833333333333333333333333333333333  $SC/flow_tiles_intb1/flow_${zone}${tile}.tif 
gdal_edit.py -a_ullr  $wS $nS $eS $sS  $SC/flow_tiles_intb1/flow_${zone}${tile}.tif 
gdal_edit.py -tr 0.000833333333333333333333333333333333 -0.000833333333333333333333333333333333  $SC/flow_tiles_intb1/flow_${zone}${tile}.tif 
...
pkfilter -nodata -9999999  -co COMPRESS=DEFLATE -co ZLEVEL=9  -ot Int32  -dx 10  -dy 10 -d 10 -f mean -i $SC/flow_tiles_intb1/flow_${zone}${tile}.tif -o $SC/flow_tiles_intb1/flow_${zone}${tile}_10p.tif
gdal_edit.py -a_nodata -9999999   $SC/flow_tiles_intb1/flow_${zone}${tile}_10p.tif 
pkgetmask -co  COMPRESS=DEFLATE -co ZLEVEL=9 -ot Byte -min -9999998 -max 99999999999999999999 -i $SC/flow_tiles_intb1/flow_${zone}${tile}.tif -o $SC/flow_tiles_intb1/flow_${zone}${tile}_msk.tif 
