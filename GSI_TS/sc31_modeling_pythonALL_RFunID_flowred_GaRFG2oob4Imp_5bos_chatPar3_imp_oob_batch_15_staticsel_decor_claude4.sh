...
# ============================================================================
# FAST STATION-MONTH LEVEL FEATURE SELECTION (IMPROVED)
# ============================================================================
...
if len(static_present) == 0:
    ...
    station_df_full['MM'] = X_train_mm  # ✓ Use extracted MM
    ...
    Y_train_station['MM'] = X_train_mm  # ✓ Use extracted MM
    ...
    if len(static_decorr) == 0:
        ...
        # ============================================================================
        # ✓ IMPROVED: Use simple ExtraTreesRegressor directly (no nested CV!)
        # ============================================================================
...
def make_rf(**kw):
    if 'n_jobs' not in kw:
        kw['n_jobs'] = 1       # ✓ Single-threaded, let GroupAwareMultiOutput parallelize
...
RFreg = GroupAwareMultiOutput(
    ...
    n_cv_folds=5,
    n_jobs=16,                 # ✓ Use all 16 cores for CV folds
    inner_n_jobs=1,            # Single-threaded RF (CV handles parallelization)
    random_state=24,
    oob_metric='r2',
    verbose=1
)
