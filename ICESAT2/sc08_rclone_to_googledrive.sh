...
##### sbatch /gpfs/gibbs/pi/hydro/hydro/scripts/ICESAT2/sc08_rclone_to_googledrive.sh
...
export DATE=$(awk 'NR=='${SLURM_ARRAY_TASK_ID}'' $INP_DIR/folderlist.txt)
...
rclone copy --fast-list --include=ATL08*  $OUP_H5    TobyData:ICESAT2/$DATE --transfers=40 --checkers=40 --tpslimit=10 --drive-chunk-size=1M --max-backlog 200000 --verbose --log-file=/gpfs/loomis/scratch60/sbsc/zt226/stdout/$DATE.log 
