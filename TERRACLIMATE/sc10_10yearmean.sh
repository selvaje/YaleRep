...
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/grace0/stdout/sc10_10yearmean.sh.%J.out
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/grace0/stderr/sc10_10yearmean.sh.%J.err
...
export VAR
export INDIR=/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/TERRACLIMATE/$VAR 
export RAM=/dev/shm
