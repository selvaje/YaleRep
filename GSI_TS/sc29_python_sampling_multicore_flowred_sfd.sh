...
### full  dataset for the sc31     da aggiornare per la floarea 
EXTRACT=/gpfs/gibbs/pi/hydro/hydro/dataproces/GSI_TS
cut -d " " -f1-19       $EXTRACT/extract_red/stationID_x_y_valueALL_predictors_floredSFD.txt  >   $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y_floredSFD.txt
cut -d " " -f1-8,20-    $EXTRACT/extract_red/stationID_x_y_valueALL_predictors_floredSFD.txt  >   $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_X_floredSFD.txt 

head -1  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y_floredSFD.txt       >  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y11_floredSFD.txt
grep -e ^11   $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y_floredSFD.txt >>  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y11_floredSFD.txt

head -1  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_X_floredSFD.txt       >  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_X11_floredSFD.txt
grep -e ^11   $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_X_floredSFD.txt >>  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_X11_floredSFD.txt

head -1  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y_floredSFD.txt       >  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y1_floredSFD.txt
grep -e ^1   $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y_floredSFD.txt >>  $EXTRACT/extract4py_red/stationID_x_y_valueALL_predictors_Y1_floredSFD.txt
