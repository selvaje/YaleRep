...
pksetmask -co COMPRESS=DEFLATE -co ZLEVEL=9 -co INTERLEAVE=BAND -ot Float32  -m $DIR/../EQUI7/grids/${CT}/PROJ/EQUI7_V13_${CT}_PROJ_ZONE_KM$KM.tif -msknodata 0 -nodata -9999 -i /dev/shm/${CT}_${5}_upa_crop.tif  -o /dev/shm/${CT}_${5}_upa_msk.tif 
