...
export tif=/gpfs/gibbs/pi/hydro/st929/SOILGRIDS2/dataprocess/${VAR}_WeAv/${VAR}_0-5cm.tif
...
gdal_translate -a_nodata -9999999   -r average  -co COMPRESS=DEFLATE -co ZLEVEL=9 -co INTERLEAVE=BAND -co TILED=YES -co NUM_THREADS=2 -of GTiff -tr 0.004166666666 0.004166666666 $SOILGRIDSSC/${dir}_acc/${tifname}_0-5cm_${zone}${tile}_acc.tif $SOILGRIDSSC/${dir}_acc/${tifname}_0-5cm_${zone}${tile}_acc_5p.tif
