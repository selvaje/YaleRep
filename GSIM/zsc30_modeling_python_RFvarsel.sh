...
#SBATCH -n 1 -c 10 -N 1
#SBATCH -t 24:00:00 
#SBATCH -o /vast/palmer/scratch/sbsc/ga254/stdout/sc30_modeling-python_RFvarsel.sh.%J.out
#SBATCH -e /vast/palmer/scratch/sbsc/ga254/stderr/sc30_modeling_python_RFvarsel.sh.%J.err
#SBATCH --job-name=sc30_modeling_python_RFvarsel.sh
#SBATCH --mem=200G

#### sbatch   /gpfs/gibbs/pi/hydro/hydro/scripts/GSIM/sc30_modeling_python_RFvarsel.sh
