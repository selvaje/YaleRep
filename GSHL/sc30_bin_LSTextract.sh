...
#SBATCH -n 1 -c 8 -N 1  
#SBATCH -t 24:00:00
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/stdout/sc30_bin_LSTextract.sh.%J.out   
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/stderr/sc30_bin_LSTextract.sh.%J.err
#SBATCH --mail-user=email
#SBATCH -J sc30_bin_LSTextract.sh

# sbatch  /gpfs/home/fas/sbsc/ga254/scripts/GSHL/sc30_bin_LSTextract.sh
...
cat  $LST/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_WGS84_bin6_clump.txt | head -10   | xargs -n 1 -P 8  bash -c $' 
BIN6ID=$1 
...
rm $LST/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_WGS84_ws_clump_bin_clump${BIN6ID}rec.tif $LST/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_WGS84_ws_clump_bin_clump${BIN6ID}rec.txt 
...
pksetmask  -co COMPRESS=DEFLATE -co ZLEVEL=9   -m $LST/LST_MOYDmax_Day_value_${BIN6ID}rec_crop_msk.tif  -msknodata -9999 -nodata 0 -i  $LST/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_WGS84_bin_${BIN6ID}_crop_msk1.tif -o  $LST/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_WGS84_bin_${BIN6ID}_crop_msk0.tif
...
rm  $LST/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_WGS84_ws_clump_bin_clump${BIN6ID}rec_crop1.tif  
...
rm -f $LST/LST_MOYDmax_Day_value_${BIN6ID}rec_bin_mean.txt  $LST/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_WGS84_ws_clump_bin_clump${BIN6ID}*
...
rm -f $LST/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_WGS84_bin_${BIN6ID}*  $LST/LST_MOYDmax_Day_value_${BIN6ID}*
