...
pkreclass  -co COMPRESS=DEFLATE  -co ZLEVEL=9  -co INTERLEAVE=BAND  -ot Float32 -nodata 0 -code  $SCRATCH/ws_areaKM2.txt -i $GSHL/final_product_1k/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_ws_clump.tif -o $SCRATCH/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_ws_clump_area.tif

oft-stat-sum -i $SCRATCH/30arc-sec-Area_prj6974.tif -o $SCRATCH/bin_area.txt -um $GSHL/final_product_1k/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_bin1-9_clump.tif   -nostd 
awk '{  printf ( "%i %.2f\n" ,   $1,    $3/1000000 )   }'  $SCRATCH/bin_area.txt | sort -g -k 1,1  >   $SCRATCH/bin_areaKM2.txt 
pkreclass  -co COMPRESS=DEFLATE  -co ZLEVEL=9  -co INTERLEAVE=BAND  -ot Float32 -nodata 0 -code  $SCRATCH/bin_areaKM2.txt -i $GSHL/final_product_1k/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_bin1-9_clump.tif  -o $SCRATCH/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_bin1-9_clump_area.tif
...
pksetmask -m $RAM/gadm36_ID_0_CT$CT.tif  -msknodata $CT -p ! -nodata 0 -i $RAM/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_bin1-9_clump_CT$CT.tif -o  $RAM/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_bin1-9_clump_CT${CT}_msk.tif
...
rm -f $RAM/30arc-sec-Area_prj6974_CT$CT.tif $RAM/gadm36_ID_0_CT$CT.tif 
rm -f $RAM/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_ws_clump_CT${CT}_msk.tif      $RAM/ws_area_CT$CT.txt
rm -f $RAM/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_bin1-9_clump_CT${CT}_msk.tif  $RAM/bin_area_CT$CT.txt
' _ 
