...
print(f'Using FULL training data for feature selection: {X_sample.shape[0]} rows')
print(f'Full temporal variance preserved')
...
if len(static_decorr) == 0:
    ...
    step_size = max(3, int(len(static_decorr) * 0.20))
    min_features = max(10, int(len(static_decorr) * 0.30))
