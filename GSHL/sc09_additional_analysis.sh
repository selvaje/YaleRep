...
#SBATCH -n 1 -c 1 -N 1
#SBATCH -t 24:00:00
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/grace0/stdout/sc09_additional_analysis.sh%J.out 
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/grace0/stderr/sc09_additional_analysis.sh%J.err
...
GSHL=/project/fas/sbsc/ga254/grace0.grace.hpc.yale.internal/dataproces/GSHL
