...
$DIR/global_prediction/map_pred_DNH4_mask_clean.txt $DIR/global_prediction/map_pred_NO3_mask_clean.txt $DIR/global_prediction/map_pred_TN_mask_clean.txt \
 ...
 <(awk ' {print  sqrt ( $1 ) *  1.285892198   }' $DIR/global_wsheds/30arc-sec-Area_prj6842_mskNO3_clean.txt )   >> $DIR/emision_table.txt
...
tar -czvf    $DIR/emision_table_valid_cor_area_width.tar.gz   $DIR/emision_table_valid_cor_area_width.txt
