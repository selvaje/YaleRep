...
#SBATCH -n 1 -c 1 -N 1
#SBATCH -t 2:00:00
#SBATCH -o /gpfs/scratch60/fas/sbsc/zt226/stdout/sc02_GEDI_ICESAT2_plot_new.sh.%A_%a.out  
#SBATCH -e /gpfs/scratch60/fas/sbsc/zt226/stderr/sc02_GEDI_ICESAT2_plot_new.sh.%A_%a.err
#SBATCH --mem=30G
#SBATCH --array=70,75,80,85,90,95
#SBATCH --job-name=sc02_GEDI_ICESAT2_plot_new.sh
ulimit -c 0

#### sbatch /gpfs/gibbs/pi/hydro/hydro/scripts/GEDI_ICESAT2/sc02_GEDI_ICESAT2_plot_new.sh
