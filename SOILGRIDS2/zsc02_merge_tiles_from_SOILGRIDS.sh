...
#SBATCH -n 1 -c 10 -N 1
#SBATCH -t 24:00:00                                                                                                         
#SBATCH -o /vast/palmer/scratch/sbsc/sm3665/stdout/sc02_merge_tiles_from_SOILGRIDS.sh.%J.out
#SBATCH -e /vast/palmer/scratch/sbsc/sm3665/stderr/sc02_merge_tiles_from_SOILGRIDS.sh.%J.err
...
export OUTPUTw250=${sc_root}/SOILGRIDS2/${var}/wgs84_250m
