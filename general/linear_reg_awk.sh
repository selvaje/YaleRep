...
END{ 
  print ("slope"      ,  ((xysum / obs) - (xsum / obs * ysum / obs ))  / (x2sum / obs - (xsum / obs * xsum / obs   )))
  print ("Intercept"  ,  (ysum / obs ) - (((xysum / obs) - (xsum / obs * ysum / obs ))  / (x2sum / obs - (xsum / obs * xsum / obs))) * xsum / obs   )
  print ("R"          ,  (obs * xysum - xsum * ysum)/((sqrt(obs*x2sum - xsum*xsum)) * (sqrt(obs*y2sum - ysum*ysum))))
    }' $1
