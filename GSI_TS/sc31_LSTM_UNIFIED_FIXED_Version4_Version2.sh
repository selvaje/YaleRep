...
#SBATCH -n 1 -c 16 -N 1
#SBATCH -t 24:00:00
#SBATCH -o /nfs/roberts/scratch/pi_ga254/ga254/stdout/sc31_LSTM_UNIFIED_FIXED_V4.%A_%a.out
#SBATCH -e /nfs/roberts/scratch/pi_ga254/ga254/stderr/sc31_LSTM_UNIFIED_FIXED_V4.%A_%a.err
#SBATCH --job-name=sc31_LSTM_UNIFIED_V4
#SBATCH --array=500
#SBATCH --mem=120G
...
print("\n" + "="*100)
print("SC31: UNIFIED LSTM PIPELINE v4 - ROBUST VARIABLE SELECTION")
print("="*100)
