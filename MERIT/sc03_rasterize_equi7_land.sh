...
# same procedure for the grids_adjusted 
# NON MODIFICATA 
# rm -f $EQUI_AD/$CT/PROJ/EQUI7_V13_${CT}_PROJ_ZONE_KM$KM.tif   
# gdal_rasterize -at  -co COMPRESS=DEFLATE -co ZLEVEL=9 -co INTERLEAVE=BAND -burn 255  -l "EQUI7_V13_${CT}_PROJ_ZONE" -tap  -a_nodata 0 -ot Byte \
# -te $( getCornersOgr4Gwarp   $EQUI_AD/$CT/PROJ/EQUI7_V13_${CT}_PROJ_ZONE.shp )  -tr $res $res  $EQUI_AD/$CT/PROJ/EQUI7_V13_${CT}_PROJ_ZONE.shp $EQUI_AD/$CT/PROJ/EQUI7_V13_${CT}_PROJ_ZONE_KM$KM.tif   
# gdal_edit.py -a_nodata 0 $EQUI_AD/$CT/PROJ/EQUI7_V13_${CT}_PROJ_ZONE_KM$KM.tif   

rm -f $EQUI_AD/$CT/GEOG/EQUI7_V13_${CT}_GEOG_ZONE_KM$KM.tif   
gdal_rasterize -at  -co COMPRESS=DEFLATE -co ZLEVEL=9 -co INTERLEAVE=BAND -burn 255  -l "EQUI7_V13_${CT}_GEOG_ZONEBUFLARGE"  -a_nodata 0 -ot Byte \
-te -180 -60 180 85  -tr  ${RES:0:22} ${RES:0:22}  $EQUI_AD/$CT/GEOG/EQUI7_V13_${CT}_GEOG_ZONEBUFLARGE.shp  $EQUI_AD/$CT/GEOG/EQUI7_V13_${CT}_GEOG_ZONEBUFLARGE_KM$KM.tif   
gdal_edit.py -a_nodata 0 $EQUI_AD/$CT/GEOG/EQUI7_V13_${CT}_GEOG_ZONEBUFLARGE_KM$KM.tif   
...
# inserted by hand -skipfailures for NA 

for CT  in  AF  AN  AS  EU  NA  OC  SA ; do
rm -f $RAM/EQUI7_V13_${CT}_GEOG_ZONEBUFLARGE.*
ogr2ogr -skipfailures   -clipdst    $EQUI_AD/$CT/GEOG/EQUI7_V13_${CT}_GEOG_ZONEBUFLARGE.shp  $RAM/EQUI7_V13_${CT}_GEOG_ZONEBUFLARGE.shp       /gpfs/loomis/project/fas/sbsc/ga254/dataproces/MERIT/input_tif/all_tif_shp.shp
ogrinfo -geom=NO -al $RAM/EQUI7_V13_${CT}_GEOG_ZONEBUFLARGE.shp   | grep _dem.tif | awk '{  print $4 }'  >  $EQUI_AD/$CT/GEOG/EQUI7_V13_${CT}_GEOG_TILEMERIT.txt 
done 


for CT  in  AF  AN  AS  EU  NA  OC  SA ; do
rm -f $RAM/EQUI7_V13_${CT}_GEOG_ZONE.*
ogr2ogr  -clipdst    $EQUI_AD/$CT/GEOG/EQUI7_V13_${CT}_GEOG_ZONE.shp  $RAM/EQUI7_V13_${CT}_GEOG_ZONE.shp       /gpfs/loomis/project/fas/sbsc/ga254/dataproces/MERIT/input_tif/all_tif_shp.shp
ogrinfo -geom=NO -al $RAM/EQUI7_V13_${CT}_GEOG_ZONE.shp   | grep _dem.tif | awk '{  print $4 }'  >  $EQUI_AD/$CT/GEOG/EQUI7_V13_${CT}_GEOG_TILEMERIT.txt 
done 
