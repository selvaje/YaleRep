...
#### sbatch --exclude=r818u29n01,r818u23n02 --export=dir=clay,tifname=clay_0-200cm --job-name=sc11_tiling20d_SOILGRIDS_clay_0-200cm.sh  /gpfs/gibbs/pi/hydro/hydro/scripts/SOILGRIDS2/sc11_tiling20d_SOILGRIDS_sfd_Int_g84.sh

#### for dir in bdod cec cfvo clay nitrogen ocd phh2o sand silt soc; do sbatch --exclude=r805u25n04,r806u14n01 --export=dir=$dir,tifname=${dir}_0-200cm --job-name=sc11_tiling20d_SOILGRIDS_$tifname.sh /gpfs/gibbs/pi/hydro/hydro/scripts/SOILGRIDS2/sc11_tiling20d_SOILGRIDS_sfd_Int_g84.sh   ; done

#### sbatch --exclude=r818u29n01,r818u23n02 --export=dir=ocs,tifname=ocs_0-30cm --job-name=sc11_tiling20d_SOILGRIDS_ocs_0-30cm.sh /gpfs/gibbs/pi/hydro/hydro/scripts/SOILGRIDS2/sc11_tiling20d_SOILGRIDS_sfd_Int_g84.sh

ocs ocs_0-30cm_NA_acc_sfd_Int_g84.tif 
