...
##### sbatch /vast/palmer/home.grace/ga254/scripts/ONCHO/sc05_downloadPoint_RFmodel_rasterRFcrop.sh
...
e <- extent(14, 15, 14, 15)
for (var in names(table)[-1] ) {
print(var)
raster  = crop(raster (Sys.glob(paste0("../input/*/",var,".tif")  )),e)
