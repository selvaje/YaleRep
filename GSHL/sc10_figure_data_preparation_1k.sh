...
#SBATCH -n 1 -c 1 -N 1  
#SBATCH -t 24:00:00
#SBATCH -o /gpfs/scratch60/fas/sbsc/ga254/stdout/sc10_figure_data_preparation_1k.sh.%J.out  
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/stderr/sc10_figure_data_preparation_1k.sh.%J.err
...
gdal_translate -co COMPRESS=DEFLATE -co ZLEVEL=9  -projwin  -1.25 52.5 0.8 50.7  /project/fas/sbsc/ga254/dataproces/MYOD11A2_celsiusmean/LST_MOYDmax_Day_spline_month7.tif   $DIR/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_figure/LST_MOYDmax_Day_spline_month7_london.tif
gdal_translate -co COMPRESS=DEFLATE -co ZLEVEL=9  -projwin   1.41 50 3.4 48 /project/fas/sbsc/ga254/dataproces/MYOD11A2_celsiusmean/LST_MOYDmax_Day_spline_month7.tif   $DIR/GHS_BUILT_LDS2014_GLOBE_R2016A_54009_1k_v1_0_figure/LST_MOYDmax_Day_spline_month7_paris.tif
