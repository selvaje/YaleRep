...
#SBATCH -e /gpfs/scratch60/fas/sbsc/ga254/stderr/sc04_equi7_reproj_dem.sh.%J.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=email
#SBATCH --job-name=sc04_equi7_reproj_dem.sh

# for CT in EU AF AN AS NA OC SA ; do   sbatch --export=CT=$CT  /gpfs/home/fas/sbsc/ga254/scripts/MERIT/sc04_equi7_reproj_dem.sh ; done 
